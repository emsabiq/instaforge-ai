...
export function configSummary() {
  return {
    ...
    videoEngine: clean(process.env.VIDEO_ENGINE || "ffmpeg"),
    videoAudience: clean(process.env.VIDEO_AUDIENCE || "general"),
    videoAspectRatio: clean(process.env.VIDEO_ASPECT_RATIO || "9:16"),
    replicateModel: clean(process.env.REPLICATE_VIDEO_MODEL || "lightricks/ltx-2.3-fast"),
    replicateReady: Boolean(clean(process.env.REPLICATE_API_TOKEN)),
